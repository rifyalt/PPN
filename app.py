...
voucher_sheet = client.open_by_key(sheet_id).worksheet("OPSI 2 - Data Voucher")
ticket_sheet = client.open_by_key(sheet_id).worksheet("OPSI 2 - Riwayat Klaim Ticketin")
hotel_sheet = client.open_by_key(sheet_id).worksheet("OPSI 2 - Riwayat Klaim Hotel")
